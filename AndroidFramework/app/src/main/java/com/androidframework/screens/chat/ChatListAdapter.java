...
public class ChatListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (message.getUserType() == UserType.SELF) {
            ...
            holder1.messageTextView.setText(Emoji.replaceEmoji(message.getMessageText(),
                    holder1.messageTextView.getPaint().getFontMetricsInt(),
            ...
            holder2.messageTextView.setText(Emoji.replaceEmoji(message.getMessageText(),
            ...
            if (message.getMessageStatus() == Status.DELIVERED) {
                holder2.messageStatus.setImageDrawable(context.getResources()
    ...
    public void refreshAapter(ArrayList<ChatMessage> chatMessages) {
        this.chatMessages = chatMessages;
